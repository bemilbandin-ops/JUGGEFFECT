...
const FROZEN_PRESETS = [
  ...
  },
  {
    ...
    settings: {
      ...
      poiPovRetention: 480,
      poiPovFadeMode: 'exponential',
      poiPovColumnSpacing: 5,
      poiPovMotionMode: 'free',
      poiGlowEnabled: true,
      poiGlowRadius: 5,
      poiGlowIntensity: 0.55,
      poiLedCount: 0,
    }
  },
  {
  ...
  },
  {
    id: 'arcade-blocks',
    name: 'Arcade Blocks',
    description: 'Chunky color blocks snap across a crisp retro motion trail.',
    icon: 'Blocks',
    ...
    settings: {
      ...
      poiPovRetention: 420,
      poiPovFadeMode: 'sharp',
      poiPovColumnSpacing: 8,
      poiPovMotionMode: 'free',
      poiGlowEnabled: true,
      poiGlowRadius: 2,
      poiGlowIntensity: 0.2,
      poiLedCount: 0,
    }
  }
];
