...
const FROZEN_PRESETS = [
  ...
  },
  {
    id: 'light-wheels',
    name: 'Light Wheels',
    description: 'Optimized for spinning clubs to create seamless circular mandalas.',
    icon: 'Aperture',
    color: 'text-orange-400 border-orange-500/20 hover:border-orange-500/40 bg-orange-950/10',
    settings: {
      enableTrails: true,
      enablePoiMode: true,
      poiPatternType: 'mandala',
      poiOrientation: 'club',
      enableLightTracking: true,
      lightThreshold: 200,
      echoFadeRate: 0.02,
      ...
      poiOpacity: 1.0,
      poiPovEnabled: true,
      poiPovRetention: 1000,
      poiPovFadeMode: 'linear',
      poiPovColumnSpacing: 2,
      poiPovMotionMode: 'circular',
      poiGlowEnabled: true,
      poiGlowRadius: 8,
      poiGlowIntensity: 0.6,
      poiLedCount: 0,
    }
  },
  {
    id: 'vaporwave-sweep',
    name: 'Vaporwave Sweep',
    description: 'Smear a solid neon ribbon through the air with a sharp cut-off.',
    icon: 'Waves',
  ...
  },
  {
    id: 'text-writer',
    name: 'Air Writer',
    description: 'Paints scrolling text vertically in the air.',
    icon: 'Type',
    color: 'text-emerald-400 border-emerald-500/20 hover:border-emerald-500/40 bg-emerald-950/10',
    settings: {
      enableTrails: true,
      enablePoiMode: true,
      poiPatternType: 'text',
      poiText: 'JUGGLE',
      poiOrientation: 'vertical',
      enableLightTracking: true,
      lightThreshold: 200,
      blurAmount: 0,
      poiHeight: 0,
      poiWidth: 4,
      poiSpeedMultiplier: 1.0,
      poiMappingMode: 'spatial',
      poiRenderMode: 'dots',
      poiOpacity: 1.0,
      poiPovEnabled: true,
      poiPovRetention: 1500,
      poiPovFadeMode: 'linear',
      poiPovColumnSpacing: 3,
      poiPovMotionMode: 'free',
      poiGlowEnabled: true,
      poiGlowRadius: 4,
      poiGlowIntensity: 0.8,
    }
  }
];
